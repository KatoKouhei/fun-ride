...
@section('content')
<head>
    <title>管理者登録（グループ）｜さあ、ファンライドを開催しよう！ファンライドイベント作成サイト【ファンライド】</title>
</head>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item border-left">
                    <a class="nav-link text-orange" href="/community/{{$community->id}}">
                      <i class="fas fa-user-plus"></i> グループ管理者の登録を完了する
                    </a>
                </li>
                {{-- <li class="nav-item border-left">
...
<form method="POST" action="/addAdministor/create/{{$community->id}}">
    @csrf
                ...
                <table class="table mb-0">
                    @foreach($addministrator_user as $user)
                        <tr>
                            ...
                            <td>
                                <div class="">
                                    <a class="nav-link btn btn-info font-weight-bold" href="/addAdministor/delete/{{$community->id}}/{{$user->id}}">登録解除</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
