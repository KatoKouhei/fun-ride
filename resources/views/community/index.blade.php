        ...
        <div class="card">
            <div class="row mx-0">
                ...
                <div class="w-75 mx-0">
                    ...
                    <div class="card-body">
                        <h4 class="card-title" id="community_subtitle">{{$community->community_subtitle}}</h4>
                                    ...
                                    @foreach($user_1 as $user)
                                        <div class="">
                                            <a class="nav-link m-0 p-0 text-dark" href="/user/{{$user->id}}">
                                                ...
                                                <label class="px-1 d-line-block my-2">{{$user->name}}</label>
                                            </a>
                                        </div>
                                    @endforeach
                                </div>
